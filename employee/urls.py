...
urlpatterns = [
    ...
    url(r'^services/service_info/service_choose/(\d+)', service_choose, name="service_choose"),
    url(r'^services/service_info/service_leave/(\d+)', service_leave, name="service_leave"),
]
