...
urlpatterns = [
    ...
    url(r'^service_choose/(\d+)', service_choose, name="service_choose"),
    url(r'^service_info/service_choose/(\d+)', service_choose, name="service_choose"),
    url(r'^service_leave/(\d+)', service_leave, name="service_leave"),
    url(r'^service_info/service_leave/(\d+)', service_leave, name="service_leave"),
    url(r'^service_info/(\d+)', service_info, name="service_info"),
]
